...
<p className="text-lg font-semibold text-center text-gray-600 mb-12">
  Meet the stars who are redefining entertainment across India ✨
</p>
  ...
  <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center bg-purple-50 rounded-3xl shadow-xl px-8 py-12">
    ...
    <div>
      ...
      <p className="text-gray-700 text-lg mb-4">
         Got talent? Whether you belt soul-stirring melodies, move crowds with dance, drop epic DJ beats, or own the mic with powerful words — Artistly is your launchpad to the spotlight.
      </p>
      <p className="text-gray-700 text-base">
         Take center stage at college fests, cultural nights, corporate shows, and more. Submit your profile and let your talent take flight — the world is waiting to cheer for you!
      </p>
